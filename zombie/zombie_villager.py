# Simulates carrot, iron, potato, and rotten flesh drops from zombie villagers
import argparse
...
ZOMBIE_VILLAGER_MD5_0 = 0x81cf840507349dba
ZOMBIE_VILLAGER_MD5_1 = 0x2a6ebd4cf7fd59f3
...
def get_xoro_state(world_seed: int):
    ...
    lo = mix_stafford13(unmixed_lo ^ ZOMBIE_VILLAGER_MD5_0)
    hi = mix_stafford13(unmixed_hi ^ ZOMBIE_VILLAGER_MD5_1)
...
def simulate_zombie_villager(world_seed: int, max_drops, target_item: str):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Zombie Villager drop")
    ...
    seq = simulate_zombie_villager(args.seed, args.d, args.i)
    print(f"Seed {args.seed} zombie villager {args.i} drops: {seq}")
