...
- [**Xpple**](https://github.com/xpple) — Provided the 1.20-pre5+ gravel loot drop logic, which, in my opinion, started this. Also pointed out that archaeology is not seed-dependent.
