...
CAT_MD5_0 = 0xdc5dfb222b5ee77f
CAT_MD5_1 = 0x8e7e13a37e7fe6bb
...
def cat_string_sequence(seed, max_seq=MAX_SEQUENCE):
    # hash hash hash hash
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Cat string drops")
    parser.add_argument("seed", type=int)
    parser.add_argument("-d", type=int, default=MAX_SEQUENCE)
    args = parser.parse_args()

    seq = cat_string_sequence(args.seed, args.d)
    print(f"Seed {args.seed} cat string drops: {seq}")
